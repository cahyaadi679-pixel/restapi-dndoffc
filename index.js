...
const settings = {
  ...
  apiSettings: {
    ...
    linkTelegram: "https://t.me/dndstoreontele",
    linkWhatsapp: "https://whatsapp.com/channel/0029Vb6C5jL4SpkIgR7iD841",
    linkYoutube: "https://youtube.com/@dndofficial-1"
};
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = {
        status: data.status,
        creator: settings.apiSettings.creator || "Created Using REST API DND",
        ...data
      };
